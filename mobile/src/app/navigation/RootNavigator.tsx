...
function MainTabs() {
  ...
  return (
    ...
    >
      ...
      {!isAdmin ? <Tab.Screen name="Trace" component={DecisionTraceScreen} options={{ title: "Trace" }} /> : null}
      {!isAdmin ? <Tab.Screen name="Profile" component={StudentPortalScreen} options={{ title: "Profile" }} /> : null}
