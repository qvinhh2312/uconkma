...
arithmeticExpression
    : primaryExpression (arithmeticOp primaryExpression)*
    ;
...
createTransactionStatement
    : 'create' ID '(' (expression (',' expression)*)? ')'
    ;

auditLogStatement
    : 'create' 'AuditLog' '(' (expression (',' expression)*)? ')'
    ;

deleteTransactionStatement
    : 'delete' ID '(' (expression (',' expression)*)? ')'
    ;

standardUpdateStatement
    : variableAccess assignmentOp expression
    ;
