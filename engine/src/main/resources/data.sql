...
MERGE INTO class_section (class_id, capacity, enrolled, reserved_seats, schedule_slots, status, version, course_id) KEY(class_id)
VALUES ('CS101_01', 30, 10, 0, 'T2_1-3', 'OPEN', 0, 'CS101');

MERGE INTO class_section (class_id, capacity, enrolled, reserved_seats, schedule_slots, status, version, course_id) KEY(class_id)
VALUES ('CS102_01', 5, 4, 0, 'T3_1-3,T5_4-6', 'OPEN', 0, 'CS102');
